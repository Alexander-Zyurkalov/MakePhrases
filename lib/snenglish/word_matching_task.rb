...
SQL
        ...
        we_need_more_phrases_to_show = count_of_shown_phrases < 3
        # --------------------
        self.english_word.
          ...
          we_still_need_more_phrases_to_show = count_of_shown_phrases < 3
