...
load_csv(SNEnglish::SrtPhrase, args[:csv_database])unless args[:csv_database] == nil
load_csv(SNEnglish::EnglishWord, args[:csv_words]) unless args[:csv_words] == nil
load_csv(SNEnglish::EnglishWord, args[:csv_words2]) unless args[:csv_words2] == nil
load_csv(SNEnglish::WordPhraseRelation, args[:csv_phrases]) unless args[:csv_phrases] == nil
